...
<head>
    ...
    <body class="mod-bg-1 mod-nav-link ">
        ...
        $users = [
            [
                'image' => '20 tasks/img/demo/avatars/avatar-b.png',
                'name' => 'Oliver Kopyov',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-c.png',
                'name' => 'Sesha Gray',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-e.png',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-k.png',
                'name' => 'Jim Ketty',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-g.png',
                'name' => 'Dr. John Oliver',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-h.png',
                'name' => 'Sarah McBrook',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-i.png',
                'name' => 'Jimmy Fellan',
            ...
            [
                'image' => '20 tasks/img/demo/avatars/avatar-j.png',
                'name' => 'Arica Grace',
                'position' => 'Accounting, Gotbootstrap Inc.',
                    ...
                    <div id="c_1" class="card border shadow-0 mb-g shadow-sm-hover" data-filter-tags="<?php echo $value['name'] ?>"> 
                        <div class="card-body border-faded border-top-0 border-left-0 border-right-0 rounded-top">
                            <div class="d-flex flex-row align-items-center">
                                <span class="status <?php echo $value['status'] ?> mr-3">
                        ...
                        <div class="card-body p-0 collapse show">
                            <div class="p-3">
                                <a href="tel:+13174562564" class="mt-1 d-block fs-sm fw-400 text-dark">
                                    <i class="fas fa-mobile-alt text-muted mr-2"></i><?php echo $value['number'] ?></a>
